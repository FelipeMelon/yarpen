...
async def on_message(message):
    ...
    if message.content.startswith('Elo'):
    ...
    elif message.content.startswith('Spamrundie'):
        await message.channel.send('He is so gay that you cannot believe it!')
        ...
        a = ['krzak1.png', 'krzak2.png', 'krzak3.png', 'krzak4.png', 'krzak5.png', 'krzak6.png', 'krzak7.png', 'krzak8.png', 'krzak9.png', 'krzak10.png', 'krzak12.png', 'krzak13.png', 'krzak14.png', 'krzak15.png' ]
